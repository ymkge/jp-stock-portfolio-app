...
## next step
- **[改善]注目フラグの再整理_売買判断を単純にできるように**: 現状の注目フラグの内容をどう判断するか？についてより精緻かつ単純に判断できるようにしたい。3/11時点でのフラグ点灯内容は以下
  - 注目＋長期調整
  - チャンス＋長期調整
  - チャンスのみ
  - 長期調整
  - 加熱気味
  - ピークアウト
    - 注目とチャンスはダイヤと炎マーク片方や両方バージョンがある。
    - 加熱気味とピークアウトはマークの色も変わる
  - 判断したいのは、様子見、買い、売りの情報のみのため、そこにもっと紐づいた判断をできるように調整できないかを検討。
