...
## next step
- **[BUG]米国株式の現在株価(円換算)がドルになっている**: 原因調査して修正する
- **[UI改善]国内株式と米国株式の前日比の比率情報に%をつける**:投資信託のみ前日比の比率情報に%がついているので、仕様を合わせる
- **[改善]ポートフォリオ特性 (Radar Chart)の安全性の仕様調整について**: 安全性が常に平均よりも低いグラフになっている原因の調査
    - 必要に応じて仕様を調整する
